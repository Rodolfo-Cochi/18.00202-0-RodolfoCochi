...
public class Main {
    public static void main(String[] args) {
        ...
        //Printar
        System.out.println("---------------------------------------------------------------------------------------");
        System.out.println(String.format("Usuario %s;Id %s;saldo %.2f", nome, conta.getIdConta(), conta.getSaldo()));
        System.out.println(String.format("Usuario %s;Id %s;saldo %.2f", nome2, conta2.getIdConta(), conta2.getSaldo()));
        System.out.println(String.format("Usuario %s;Id %s;saldo %.2f", nome3, conta3.getIdConta(), conta3.getSaldo()));
        ...
        //Operacoes
        Transacoes.transferirSaldo(conta2,conta,pedido2);
        //Printar
        System.out.println("---------------------------------------------------------------------------------------");
        System.out.println(String.format("Usuario %s;Id %s;saldo %.2f", nome, conta.getIdConta(), conta.getSaldo()));
        System.out.println(String.format("Usuario %s;Id %s;saldo %.2f", nome2, conta2.getIdConta(), conta2.getSaldo()));
